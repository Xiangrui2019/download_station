...
$FileTurePath = $Path . $F;
if (empty("$F")) exit;
else if (!file_exists($FileTurePath)) exit;
else {
...
<div class="mdui-container" style="max-width: 400px; ">
  ...
  <div class="mdui-card">
    ...
    <div class="mdui-card-content">
      <?php if (empty($Introduction)) echo '啊偶，该文件夹存在密码保护';
      else echo $Introduction; ?><br><?php if (!empty($IntroductionO)) echo $IntroductionO; ?>
