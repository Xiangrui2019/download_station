...
<div class="mdui-container doc-container">
    <div class="mdui-typo">
	  ...
	  <div class="mdui-row">
	  <div class="mdui-col-xs-6"><div class="mdui-textfield"><input id="VerificationCode" name="VerificationCode" class="mdui-textfield-input" type="text" placeholder="邮件验证码"/></div></div>
            ...
            xhr.onreadystatechange = function(){
                if (xhr.readyState==4 && xhr.status==200){
					...
					if(xhr.responseText==1){
						mdui.dialog({title:'提交成功',content:'恭喜您，文件提交成功；您的文件将在审核通过后被上传到本站，审核结果我们会通过邮件通知您！',modal:true});
